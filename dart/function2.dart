...
String signInWithGitHub() =>
    "String function value returning"; //single line code
...
signInWithEmailAndPassword(
    ...
    String? password}) {} //named parametrede genel kullanım bu şekilde
...
urlShorter(String currentUrl,
    {bool? withDot,
    bool?
        longShort}) {} //named ve unnamed bu şekilde kullanılabilir ama string değer olması lazım

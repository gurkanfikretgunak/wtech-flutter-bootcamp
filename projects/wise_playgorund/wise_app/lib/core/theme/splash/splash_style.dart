...
class SplashStyle {
  ...
  static ButtonStyle splashConnectWithGoogleButtonStyle = ElevatedButton.styleFrom(
  ...
  static ButtonStyle splashLoginRegisterButtonStyle =ElevatedButton.styleFrom(
    backgroundColor:
    ColorConstants.loginAndRegisterButtonColor ,
  );

  static const TextStyle splashConnectWithGoogleTextStyle=TextStyle(
      color: Colors.blue,
      fontSize: 17,
